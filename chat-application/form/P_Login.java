...
public class P_Login extends javax.swing.JPanel {
    ...
    private void cmdLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdLoginActionPerformed
        ...
        if (userName.equals("") || password.equals("")) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đầy đủ tên tài khoản hoặc mật khẩu !", "Lỗi đăng nhập", JOptionPane.ERROR_MESSAGE);

        } else {
            String hashedPassword = hashPassword(password);
            Model_Login loginData = new Model_Login(userName, hashedPassword);
            PublicEvent.getInstance().getEventLogin().login(loginData);
