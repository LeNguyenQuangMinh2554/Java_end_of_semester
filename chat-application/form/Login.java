...
public class Login extends javax.swing.JPanel {
                            ...
                            public void call(Object... os) {
                                if (os.length > 0) {
                                    ...
                                    if (action) {
                                        ...
                                        PublicEvent.getInstance().getEventMain().showLoading(false);
                                        JOptionPane.showMessageDialog(Login.this, "Tài khoản hoặc mật khẩu không đúng !", "Lỗi đăng nhập", JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        pic.setImage(new javax.swing.ImageIcon(getClass().getResource("/icon/login_image.png")));
